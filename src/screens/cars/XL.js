...
const Variant = () => {
  const [price, setPrice] = useState("11,29,000");
  return (
      ...
      <div className="container mx-auto">
        <div className="grid md:grid-cols-3 md:space-y-0 space-y-3">
          <div className="space-y-3 mx-auto md:mx-0">
            ...
            >
              <option value="11,29,000">XL6 ZETA</option>
              <option value="12,29,000">XL6 ALPHA</option>
              <option value="12,89,000">XL6 ALPHA+</option>
              <option value="13,05,000">XL6 ALPHA+ (D)</option>
              <option value="12,79,000">XL6 ZETA AUTOMATIC</option>
              <option value="13,79,000">XL6 ALPHA AUTOMATIC</option>
              <option value="14,39,000">XL6 ALPHA+ AUTOMATIC</option>
              <option value="14,55,000">XL6 ALPHA+ (D) AUTOMATIC</option>
            </select>
          </div>
