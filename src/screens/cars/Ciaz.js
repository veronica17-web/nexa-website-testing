...
const Variant = () => {
  const [price, setPrice] = useState("8,99,500");
  return (
      ...
      <div className="container mx-auto">
        <div className="grid md:grid-cols-3 md:space-y-0 space-y-3">
          <div className="space-y-3 mx-auto md:mx-0">
            ...
            >
              <option value="8,99,500">CIAZ SMART HYBRID SIGMA</option>
              <option value="9,63,500">CIAZ SMART HYBRID DELTA</option>
              <option value="9,99,000">CIAZ SMART HYBRID ZETA</option>
              <option value="10,78,500">CIAZ SMART HYBRID ALPHA</option>
              <option value="10,89,500">CIAZ SMART HYBRID CIAZ S</option>
              <option value="10,83,500">
                CIAZ SMART HYBRID AUTOMATIC DELTA
              </option>
              <option value="11,19,000">
                CIAZ SMART HYBRID AUTOMATIC ZETA
              </option>
              <option value="11,98,500">
