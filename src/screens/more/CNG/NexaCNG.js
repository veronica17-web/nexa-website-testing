...
const NexaCNG = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Nexa CNG On Road Price| Maruti Suzuki CNG Offers</title>
        <meta
          name="title"
      ...
      <div className="text-center  my-8 container mx-auto  ">
        <div className="text-2xl font-medium py-4 pt-8 lg:text-3xl ">
      ...
      <div className="text-center mt-8 container mx-auto ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 justify-center gap-4 lg:gap-8 p-2 sm:p-5   pb-5 w-full">
          {cngProducts.map((item) => (
            <div
              className="flex flex-col bg-white   rounded shadow-lg border relative overflow-hidden w-full col-span-1 "
              key={item.id}
            >
              {/* <div
      ...
      <div className="text-center my-8 container mx-auto">
        <div className="text-2xl font-medium pt-12 ">Why NEXA S-CNG?</div>
