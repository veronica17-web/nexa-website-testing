...
import { grand_vitara } from "../../constants/cars";
            ...
            <Tab.Panels>
              ...
              <Tab.Panel>
                <div className="grid grid-cols-2">
                  ...
                  <div className="bg-black p-4 text-gray-300">Petrol BS VI</div>
                  {grand_vitara.transmission.map((item) => (
                    <>
                      <div className="bg-gray-100 p-4 text-gray-700">
                        {item.body}
                      </div>
              ...
              <Tab.Panel>
                <div className="grid grid-cols-2">
                  <div className="bg-black p-4 text-gray-300">Body Type</div>
                  <div className="bg-black p-4 text-gray-300">Petrol BS VI</div>
                  {grand_vitara.dimensions.map((item) => (
                    <>
                      <div className="bg-gray-100 p-4 text-gray-700">
                        {item.body}
                      </div>
              ...
              <Tab.Panel>
                <div className="grid grid-cols-2">
                  <div className="bg-black p-4 text-gray-300">Body Type</div>
                  <div className="bg-black p-4 text-gray-300">Petrol BS VI</div>
                  {grand_vitara.suspension.map((item) => (
                    <>
                      <div className="bg-gray-100 p-4 text-gray-700">
                        {item.body}
                      </div>
