...
import { ciaz } from "../../constants/cars";
            ...
            <Tab.Panels>
              ...
              <Tab.Panel>
                <div className="grid grid-cols-2">
                  ...
                  <div className="bg-black p-4 text-gray-300">K15 SMART HYBRID</div>
              ...
              <Tab.Panel>
                <div className="grid grid-cols-2">
                  <div className="bg-black p-4 text-gray-300">DRIVE & TRANSMISSION</div>
              ...
              <Tab.Panel>
                <div className="grid grid-cols-2">
                  <div className="bg-black p-4 text-gray-300">Dimensions Type</div>
                  <div className="bg-black p-4 text-gray-300">Petrol BS VI</div>
