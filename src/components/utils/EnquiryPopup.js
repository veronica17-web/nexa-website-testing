                  ...
                  <div className="mt-4">
                    ...
                    >
                      ...
                      <div className=" pt-4  flex gap-3">
                        <button
                          type="button"
                          className="  inline-flex justify-center items-center border border-gray-300 shadow-sm py-3 bg-white text-base  text-gray-700 hover:border-gray-600 focus:outline-none   sm:text-sm rounded-md w-1/2 "
                        ...
                        <button
                          type="submit"
                          className="w-1/2 inline-flex justify-center items-center border border-transparent shadow-sm  py-3 bg-black text-base  text-white hover:bg-white hover:border hover:border-black hover:text-black duration-300 sm:text-sm rounded-md "
                        >
                          {loader ? (
